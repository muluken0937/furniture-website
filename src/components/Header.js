...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* Top contact bar */}
      <div className="bg-gray-800 text-white py-2 text-xs md:text-sm">
        <div className="container mx-auto px-4 flex flex-row justify-between items-center">
          {/* Left: contact (address, email, call) */}
          <div className="flex items-center gap-2 md:gap-4">
            <a
              href="https://www.google.com/maps/search/?api=1&query=123+Furniture+St+Design+City"
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <span className="hidden md:inline">123 Furniture St, Design City</span>
            </a>
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                className="flex items-center p-1 hover:text-primary transition"
                aria-label="Send email to info@furnicraft.com"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="inline md:hidden">Email</span>
                <span className="hidden md:inline">info@furnicraft.com</span>
              </a>
          ...
          {/* Right: socials (desktop) and mobile dropdown */}
          <div className="flex items-center">
            <div className="hidden md:flex items-center ml-6 space-x-3">
              ...
              <a href="#" className="hover:text-primary transition" aria-label="TikTok">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="hover:text-primary transition" aria-label="Telegram">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative md:hidden">
              <button
                ...
                className="flex items-center p-2 bg-gray-800 rounded-full hover:bg-primary transition"
              >
                <svg className="w-4 h-4 mr-1 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
              ...
              {showSocialDropdown && (
                <div className="absolute right-0 mt-2 w-40 bg-white text-gray-800 shadow-lg rounded-md p-2 flex flex-col space-y-2 z-50">
                  <a href="https://facebook.com" target="_blank" rel="noreferrer" className="flex items-center p-2 hover:bg-gray-100 rounded">
                    <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
                      <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.99 3.657 9.128 8.438 9.878v-6.99H7.898v-2.888h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.47h-1.26c-1.242 0-1.63.772-1.63 1.562v1.875h2.773l-.443 2.888h-2.33v6.99C18.343 21.128 22 16.99 22 12z"/>
                    </svg>
                    Facebook
                  </a>
                  <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="flex items-center p-2 hover:bg-gray-100 rounded">
                    <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
                      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                    </svg>
                    TikTok
                  </a>
                  <a href="https://instagram.com" target="_blank" rel="noreferrer" className="flex items-center p-2 hover:bg-gray-100 rounded">
                    <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <Link href="/" className="text-2xl font-bold text-primary flex items-center h-12">
              ...
              <span className="hidden lg:inline">Karis Furniture</span>
            </Link>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="p-2 text-gray-700 hover:text-primary relative" aria-label="Liked items">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="pt-4 border-t">
                  <div className="flex space-x-4 justify-center">
                    {/* Facebook */}
                    <a href="#" className="p-2 bg-gray-100 rounded-full hover:bg-primary hover:text-white transition">

...
export default function Footer() {
  ...
  const shopLinks = ['All Products', 'Living Room', 'Bedroom', 'Dining', 'Office', 'Outdoor'];
  const helpLinks = ['Customer Service', 'Track Order', 'Returns & Exchanges', 'Shipping Info', 'FAQ'];

                ...
                <div className="flex space-x-4">
                  {[
                    ...
                    <a
                      key={social.name}
                      href="#"
                      className="w-12 h-12 bg-gray-100 hover:bg-primary rounded-full flex items-center justify-center transition duration-200 group"
                    >
                      <div className="w-6 h-6 bg-gray-400 group-hover:bg-white rounded-full"></div>
                    </a>
                  ))}
                </div>
              </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-primary hover:bg-primary-dark disabled:bg-gray-400 text-white py-3 px-6 rounded-lg font-medium transition duration-200 flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
